<?php
    ...
    if(isset($_POST['job_application'])&& isset($_FILES['attachment_file']) && $_FILES['attachment_file']['error'] === UPLOAD_ERR_OK){
        $decodedData = json_decode($_POST['job_application'], true);
        if (json_last_error() === JSON_ERROR_NONE) {
            ...
            try{
                ...
                $mail->Subject = 'Candidature-'.$job;//sujet
